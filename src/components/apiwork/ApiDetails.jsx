                    ...
                    <div className="col-md-7">
                        <div className="card p-3 py-4">
                            <div className="text-center">
                                <img src={empApi.imageUrl} alt={empApi.id} width="100" className="rounded-circle" />
                            </div>
                            <div className="text-center mt-3">
                                <span className="bg-secondary p-1 px-4 rounded text-white">{empApi.age}</span>
                                ...
                                <div className="buttons">
                                    <button className="btn btn-outline-primary px-4">{empApi.contactNumber}</button>
                                    <br /><br />
                                    <button className="btn btn-warning px-5 ms-3" onClick={() => navigation(-1)}>
